   ...
   <section class="mb-8 relative">
    ...
    <div class="relative flex flex-col sm:flex-row bg-blue-50 border border-blue-200 rounded-md p-3 sm:p-4">
     ...
     <div class="flex-shrink-0 mb-3 sm:mb-0 sm:mr-4">
      <img alt="NCT DREAM group photo with colorful background" class="rounded" height="90" src="https://storage.googleapis.com/a1aa/image/dbc07ccd-eb0e-4bd8-6a9e-3f798ca0d76f.jpg" width="120"/>
     </div>
     <div class="flex-1 flex flex-col justify-between">
      ...
      <div class="flex flex-col items-end mt-2 space-y-1">
       ...
       <button class="bg-red-600 text-white text-xs px-3 py-1 rounded shadow-sm hover:bg-red-700 transition" type="button">
        Remove
       </button>
      </div>
     </div>
