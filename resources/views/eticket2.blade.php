...
<body class="bg-white">
    ...
    <main class="max-w-4xl mx-auto p-4">
        <div class="bg-white border border-[#0B1460] rounded-md shadow-md p-6 mb-6 select-none" style="font-family: Arial, sans-serif">
            ...
            <section class="bg-[#0B1460] rounded-md p-6 mb-6 text-white">
                ...
                <dl class="grid grid-cols-[auto_1fr] gap-x-2 gap-y-1 text-sm leading-tight">
                    ...
                    <dd>: Taylor Swift | The Eras Tour</dd>
        ...
        <div class="flex justify-center mb-12">
            <button id="paymentButton" class="bg-[#607d8b] text-white font-semibold rounded-md px-6 py-2 text-sm select-none hover:bg-[#546e7a] transition-colors" type="button">
                Make Payment
            </button>
        </div>
    </main>
    ...
    <div id="paymentModal" class="modal" style="display:none;">
        <div class="bg-white max-w-md w-full rounded-md shadow-lg p-6 text-center select-none">
            <p class="font-semibold text-lg mb-2">Virtual Account</p>
            <div class="flex justify-center items-center mb-2">
                <p class="font-extrabold text-3xl tracking-tight">12345678912090</p>
                <i class="far fa-copy text-black text-2xl ml-2 cursor-pointer" title="Copy virtual account number"></i>
            </div>
            <p class="text-xs">Lakukan Pembayaran sebelum 59.30</p>
        </div>
    </div>
    <!-- Footer -->
    ...
    <script>
        ...
        // Close modal when clicking the copy icon (optional: you can add copy functionality here)
        var copyIcon = modal.querySelector("i.far.fa-copy");
        copyIcon.addEventListener("click", function() {
            const vaNumber = "12345678912090";
